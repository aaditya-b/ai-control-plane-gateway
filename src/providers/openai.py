...
_DEFAULT_MODELS = ["gpt-4o", "gpt-4o-mini", "gpt-4-turbo", "gpt-3.5-turbo"]
...
class OpenAIProvider(BaseProvider):
    ...
    async def chat_completion(
        ...
        body["stream"] = False
        # Enable OpenAI server-side prompt caching (automatic on gpt-4o / gpt-4-turbo).
        # Setting store=False ensures inputs are not used for model training.
        if req.model and ("gpt-4o" in req.model or "gpt-4-turbo" in req.model):
